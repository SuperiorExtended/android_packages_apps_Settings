...
public class SettingsHomepageActivity extends FragmentActivity implements
	...
	textView.setText(getOwnerName());

	if ((hourOfDay >= 5 && hourOfDay <= 10) || (hourOfDay >= 16 && hourOfDay <= 17)) {
	    homepageTitle.setText(msgRandom[rd]);
	} else if (hourOfDay >= 18 && hourOfDay <= 20) {
	    homepageTitle.setText(msgRandom[rd]);
	} else if ((hourOfDay >= 21 && hourOfDay <= 23) || (hourOfDay >= 0 && hourOfDay <= 4)) {
	    homepageTitle.setText(msgRandom[rd]);
